# -*- encoding: utf-8 -*-
# stub: solidus_core 2.9.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<actionmailer>.freeze, [">= 5.1", "< 5.3.x"])
      s.add_runtime_dependency(%q<actionpack>.freeze, [">= 5.1", "< 5.3.x"])
      s.add_runtime_dependency(%q<actionview>.freeze, [">= 5.1", "< 5.3.x"])
      s.add_runtime_dependency(%q<activejob>.freeze, [">= 5.1", "< 5.3.x"])
      s.add_runtime_dependency(%q<activemodel>.freeze, [">= 5.1", "< 5.3.x"])
      s.add_runtime_dependency(%q<activerecord>.freeze, [">= 5.1", "< 5.3.x"])
      s.add_runtime_dependency(%q<activesupport>.freeze, [">= 5.1", "< 5.3.x"])
      s.add_runtime_dependency(%q<railties>.freeze, [">= 5.1", "< 5.3.x"])
      s.add_runtime_dependency(%q<activemerchant>.freeze, ["~> 1.66"])
      s.add_runtime_dependency(%q<acts_as_list>.freeze, ["~> 0.3"])
      s.add_runtime_dependency(%q<awesome_nested_set>.freeze, ["~> 3.0", ">= 3.0.1"])
      ...
      s.add_runtime_dependency(%q<paperclip>.freeze, [">= 4.2", "< 6"])
      ...
      s.add_dependency(%q<actionmailer>.freeze, [">= 5.1", "< 5.3.x"])
      s.add_dependency(%q<actionpack>.freeze, [">= 5.1", "< 5.3.x"])
      s.add_dependency(%q<actionview>.freeze, [">= 5.1", "< 5.3.x"])
      s.add_dependency(%q<activejob>.freeze, [">= 5.1", "< 5.3.x"])
      s.add_dependency(%q<activemodel>.freeze, [">= 5.1", "< 5.3.x"])
      s.add_dependency(%q<activerecord>.freeze, [">= 5.1", "< 5.3.x"])
      s.add_dependency(%q<activesupport>.freeze, [">= 5.1", "< 5.3.x"])
      s.add_dependency(%q<railties>.freeze, [">= 5.1", "< 5.3.x"])
      s.add_dependency(%q<activemerchant>.freeze, ["~> 1.66"])
      s.add_dependency(%q<acts_as_list>.freeze, ["~> 0.3"])
      s.add_dependency(%q<awesome_nested_set>.freeze, ["~> 3.0", ">= 3.0.1"])
      ...
      s.add_dependency(%q<paperclip>.freeze, [">= 4.2", "< 6"])
